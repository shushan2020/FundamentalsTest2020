...
public class NatureApp {
	...
	public static void main(String[] args) {
		...
		Plant flower = new Flower("Sunflower", 1, Scent.PINAPLE);
		Plant weed = new Weed("Crabgrass", 120, 200);
		Plant tree = new Tree("Aspen",2, LeafType.HEART);
		Plant broom = new Bush("broom","sweet broom",2.5,LeafType.NEEDLE);
		...
		// System.out.println("the number of animals : " +
		...
		System.out.println("the number of plants : " + forestNoteBook.getPlantCount());
		System.out.println("==========================================================\n");
